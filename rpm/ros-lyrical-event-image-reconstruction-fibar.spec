...
%global pkg_name event_image_reconstruction_fibar
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-event-image-reconstruction-fibar
Version:        3.0.4
Release:        3%{?dist}
...
%changelog
* Wed Apr 29 2026 Bernd Pfrommer <bernd.pfrommer@eventvisionresearch.com> - 3.0.4-3
- Autogenerated by Bloom

* Tue Apr 28 2026 Bernd Pfrommer <bernd.pfrommer@eventvisionresearch.com> - 3.0.4-2
- Autogenerated by Bloom

* Tue Apr 21 2026 Bernd Pfrommer <bernd.pfrommer@eventvisionresearch.com> - 3.0.4-1
- Autogenerated by Bloom
